...
const Header: React.FC<HeaderProps> = ({ setActiveSection, setShowContactForm, activeSection }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40">
      ...
      <div className="md:hidden fixed left-0 right-0 z-30 flex mt-[71px]">
        <a
          href="https://wa.me/447770365242"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-full px-6 py-3 text-base font-medium text-white bg-[#25D366] hover:bg-[#128C7E] transition-all duration-300 shadow-lg hover:shadow-xl rounded-b-lg"
        >
          <svg
      ...
      <div className={`md:hidden absolute w-full ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
        {/* Mobile Menu Items */}
        <div className="bg-white shadow-lg border-t rounded-b-2xl mt-[45px]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
